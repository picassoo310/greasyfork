// ==UserScript==
// @name              💥全网VIP视频免费破解去广告、Fuck链接中间跳转页(直接跳转)、B站哔哩哔哩使用增强、知乎使用增强等多合一纯净脚本
// @name:zh           💥全网VIP视频免费破解去广告、Fuck链接中间跳转页(直接跳转)、B站哔哩哔哩使用增强、知乎使用增强等多合一纯净脚本
// @name:zh-TW        💥全網VIP視頻免費破解去廣告、Fuck連結中間跳轉頁(直接跳轉)、B站嗶哩嗶哩使用增強、知乎使用增強等多合一純淨指令碼或直譯式程式
